...
import com.kamixiya.icm.model.content.payment.PaymentReportContractEditInfoDTO;
...
/**
 * 事前资金申请合同付款信息实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE)
public interface PaymentReportContractMapper {
    ...
    PaymentReportContract toEntity(PaymentReportContractEditInfoDTO dto);
}
