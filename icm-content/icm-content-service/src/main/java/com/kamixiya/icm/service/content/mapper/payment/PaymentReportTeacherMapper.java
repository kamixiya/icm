...
import com.kamixiya.icm.model.content.payment.PaymentReportTeacherEditInfoDTO;
...
/**
 * 事前资金申请--培训费--师资费实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE)
public interface PaymentReportTeacherMapper {
    ...
    PaymentReportTeacher toEntity(PaymentReportTeacherEditInfoDTO dto);
}
