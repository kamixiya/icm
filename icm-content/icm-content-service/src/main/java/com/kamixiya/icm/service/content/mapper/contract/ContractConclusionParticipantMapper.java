...
/**
 * 合同订立参与方信息实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ContractConclusionParticipantMapper {
    /**
     * 编辑信息转实体
     *
    ...
    ContractConclusionParticipant toEntity(ContractParticipantEditInfoDTO createInfoDTO);
