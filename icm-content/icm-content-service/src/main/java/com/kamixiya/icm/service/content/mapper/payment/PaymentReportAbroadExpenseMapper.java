...
import com.kamixiya.icm.model.content.payment.PaymentReportAbroadExpenseEditInfoDTO;
...
/**
 * 事前资金申请因公出过(境)经费实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE)
public interface PaymentReportAbroadExpenseMapper {
    ...
    PaymentReportAbroadExpense toEntity(PaymentReportAbroadExpenseEditInfoDTO dto);
}
