...
import com.kamixiya.icm.model.content.payment.PaymentReportItineraryEditInfoDTO;
...
/**
 * 事前资金申请主要行程安排实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE)
public interface PaymentReportItineraryMapper {
    ...
    PaymentReportItinerary toEntity(PaymentReportItineraryEditInfoDTO dto);
}
