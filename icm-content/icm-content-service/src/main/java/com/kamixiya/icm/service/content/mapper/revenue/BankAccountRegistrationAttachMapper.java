...
import com.kamixiya.icm.model.content.revenue.Registration.BankAccountRegistrationAttachEditInfoDTO;
...
public interface BankAccountRegistrationAttachMapper {
    ...
    @Mapping(target = "bankAccountRegistration", ignore = true)
    @Mapping(target = "showOrder", ignore = true)
    BankAccountRegistrationAttach toEntity(BankAccountRegistrationAttachEditInfoDTO createInfoDTO, @Context CycleAvoidingMappingContext context);
}
