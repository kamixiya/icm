...
import com.kamixiya.icm.model.content.payment.PaymentReportTrainingEditInfoDTO;
...
/**
 * 事前资金申请培训费实体与DTO的转换工具
 *
 * @author Zhu Jie
 * @date 2020/4/19
 */
@Mapper(componentModel = "spring", unmappedSourcePolicy = ReportingPolicy.IGNORE)
public interface PaymentReportTrainingMapper {
    ...
    PaymentReportTraining toEntity(PaymentReportTrainingEditInfoDTO dto);
}
